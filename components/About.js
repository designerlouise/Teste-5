      ...
      <section data-name="about" data-file="components/About.js" id="about" className="section-padding bg-black">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            {/* Cartão com imagem à direita */}
            <div className="bg-gradient-to-br from-[#1b0000] to-[#300000] p-8 rounded-xl shadow-xl flex flex-col items-center justify-center text-center">
              <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-red-600 mb-4">
                <img
                  src="4.png"  // Substitua pelo caminho real da imagem
                  alt="Louise Designer"
