    ...
    const materials = [
      {
        ...
        icon: 'fas fa-list-check', // ÍCONE TROCAD0
        size: '6.3 MB',
        format: 'PDF',
        url: 'https://drive.google.com/file/d/1CWn14LT02pMMaWCVaNDnHp9Xms5riejE/view?usp=drivesdk'
      },
      {
        title: 'Mini Guia da Bio Estratégica',
        description: 'Guia para você transformar a sua bio estrategicamente',
        icon: 'fas fa-images',
        size: '147,5 KB',
        format: 'PDF',
        url: 'https://drive.google.com/file/d/1D5-d7rpPRtR_TUoO9dLov228jalwOijv/view?usp=drivesdk'
      },
      {
        title: 'Apresentação Comercial',
        description: 'Apresentação completa para conhecer a Designer Louise',
        icon: 'fas fa-book', // ÍCONE TROCAD0
        size: '14.2 MB',
        format: 'PDF',
        url: 'https://drive.google.com/file/d/1Io4S5ToTSxRGPQy-0vEH69MylrbG12C2/view?usp=drivesdk'
      }
    ];
